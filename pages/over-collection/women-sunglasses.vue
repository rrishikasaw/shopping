<template>
  ...
  <div class="d-flex justify-between">
      <h3 style="font-weight: bold;" class="">Women Glasses</h3>
    ...
    <v-row class="my-10">
      ...
      <v-col cols="12" md="6" lg="3">
        <v-card>
          <img
            src="../../assets/image/women-lens/women4.jpeg"
            alt=""
            width="200"
            class="w-full"
          />
      ...
      <v-col cols="12" md="6" lg="3">
        <v-card>
          <img
            src="../../assets/image/women-lens/women5.jpg"
            alt=""
            width="200"
            class="w-full"
          />
      ...
      <v-col cols="12" md="6" lg="3">
        <v-card>
          <img
            src="../../assets/image/women-lens/women8.webp"
            alt=""
            width="200"
            class="w-full"
          />
